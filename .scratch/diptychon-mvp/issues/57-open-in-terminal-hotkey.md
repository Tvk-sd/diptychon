...
Status: **wontfix — abgelöst, geschlossen 2026-08-04 bei der Readiness-Triage (#68).**
Das eingebettete Terminal (#65, gemergt `4043372`) löst denselben Job direkt im
Fenster statt über Terminal.app. Ein externer „Open in Terminal"-Hotkey wäre jetzt
ein zweiter Weg zum selben Ziel.

Hinweis für später: auf dem verwaisten Branch `claude/open-tickets-triage-r8tzl1`
(`abd8d3e`) liegt eine nie gemergte zweite Lösung dafür — `TerminalLauncher.swift`
plus Tests. Der Branch kann weg, sobald das hier bestätigt ist.
