...
- [ ] **`coding-standards.md` anlegen?** (optional, entdeckt 2026-07-25): mattpocock `code-review` v1.2 liest eine separate Coding-Standards-Datei, wenn sie existiert — bewusst außerhalb von `CLAUDE.md`. Gibt es hier noch nicht
