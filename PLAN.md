...
- [ ] **Linear-Prototyp, zwei Bildfragen (`.scratch/landing-page/dir-linear.html`):** (1) die mittlere „Why“-Kachel („Small, native, private“) hat kein Screenshot, nur die Textliste — Bild gewünscht, und wenn ja welches? (2) `shots/tags-light.png` zeigt leere Kästchen statt Datei-Icons — Reshoot nötig, kein CSS-Fix. Layout/Copy-Runde vom 2026-09-21 ist gemerged (`e52035a`)
