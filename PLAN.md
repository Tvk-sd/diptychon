...
## Offen — bei AI
**#68 und #69 sind zu** — Gate leer (letzter Blocker #77 am 2026-08-10 behoben und empirisch bestätigt), Download notarisiert und live. **Nächstes: #71** (Startseite auf „free while in beta" umbauen) — Status `ready-for-human`, die Copy-Entscheidungen liegen bei Till; danach `ready-for-agent`. Der Build mit #77-Fix ist seit 2026-08-11 live (`1a67c05`, 2.659.156 B) — der Download promptet beim Start nicht mehr. DMG-Umstellung danach: #79.
