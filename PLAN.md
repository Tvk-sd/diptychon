...
- [ ] **Icon entscheiden (ADR 0009):** `alt-02-frosted-bw.svg` liegt eingebaut im AppIcon-Set und ist als echter Build in der Dock gesehen — eingebaut heißt aber nicht entschieden. Entweder 02 abnehmen (dann baue ich die vereinfachte 16-px-Variante und den Wordmark) oder auf 03 Keycaps zurück; Galerie: `design/icon/alternatives/index.html`
