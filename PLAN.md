...
- [ ] **#94 abnehmen, Runde 2 (Spaltenansicht, 3 Minuten):** Runde 1 durchgefallen (Fokus unsichtbar, Tab kam nicht in der Tabelle an), fünf Ursachen behoben, Sonde grün. Ungemergt im Worktree `debug/91-column-view`. Eigene Diptychon beenden, Debug-Build starten, ⌘2, dann: Ordner anklicken, ↑/↓ gemischt, →/←, ⇥ hin und zurück. Regeln stehen in `docs/user-guide.md` §8. Passt es → Commit + Merge durch AI (`.scratch/diptychon-mvp/issues/94-spaltenansicht-auswahl-oeffnet-keine-spalte.md`)
