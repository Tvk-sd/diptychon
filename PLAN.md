...
- [ ] **#95 testen und freigeben (2 Minuten):** Pfad in die Suche einfügen war tot (⌘V erreichte kein Textfeld, seit #76). Fix liegt uncommitted im Worktree `fix-path-search`; Pfad einfügen → Sprung, Feld leer. Freigabe → Commit + Merge. Nebenfund: UI-Test Tab-Fokus ist auf main rot (#96)
