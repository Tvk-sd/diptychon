...
- [ ] **#57 verifizieren:** Open-in-Terminal-Hotkey ⌘⇧T ist implementiert (Branch `claude/open-tickets-triage-r8tzl1`) — auf dem Mac bauen, volle Suite laufen lassen, manuelle ACs prüfen (cwd links/rechts, `defaults write com.diptychon.app terminalAppName iTerm`, Fallback-Hinweis, Umlaut-Pfade), dann mergen (`.scratch/diptychon-mvp/issues/57-open-in-terminal-hotkey.md`)
